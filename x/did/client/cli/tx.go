...
func NewRevokeVerificationCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: `millicashd tx did revoke-verification-method 575d062c-d110-42a9-9c04-cb1ff8c01f06 \
 Z46DAL1MrJlVW_WmJ19WY8AeIpGeFOWl49Qwhvsnn2M \
 --from alice \
 --node https://rpc.millicash.app.beta.starport.cloud:443 --chain-id millicash-testnet`,
		Args: cobra.ExactArgs(2),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
