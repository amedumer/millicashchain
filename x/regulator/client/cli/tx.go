...
func IssueLicenseCredentialCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `millicashd tx regulator issue-license-credential \ 
did:cosmos:net:millicash-testnet:regulator \
did:cosmos:net:millicash-testnet:emti \
...
func IssueRegistrationCredentialCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `millicashd tx issue-registration-credential \
did:cosmos:net:millicash-testnet:regulator \ 
did:cosmos:net:millicash-testnet:emti \
