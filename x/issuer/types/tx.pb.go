...
import (
	...
	types "github.com/millicent/millicash/x/verifiable-credential/types"
...
func init() {
	proto.RegisterType((*MsgCreateIssuer)(nil), "millicent.cash.issuer.MsgCreateIssuer")
	proto.RegisterType((*MsgCreateIssuerResponse)(nil), "millicent.cash.issuer.MsgCreateIssuerResponse")
	proto.RegisterType((*MsgBurnToken)(nil), "millicent.cash.issuer.MsgBurnToken")
	proto.RegisterType((*MsgBurnTokenResponse)(nil), "millicent.cash.issuer.MsgBurnTokenResponse")
	proto.RegisterType((*MsgMintToken)(nil), "millicent.cash.issuer.MsgMintToken")
	proto.RegisterType((*MsgMintTokenResponse)(nil), "millicent.cash.issuer.MsgMintTokenResponse")
	proto.RegisterType((*MsgPauseToken)(nil), "millicent.cash.issuer.MsgPauseToken")
	proto.RegisterType((*MsgPauseTokenResponse)(nil), "millicent.cash.issuer.MsgPauseTokenResponse")
	proto.RegisterType((*MsgIssueUserCredential)(nil), "millicent.cash.issuer.MsgIssueUserCredential")
	proto.RegisterType((*MsgIssueUserCredentialResponse)(nil), "millicent.cash.issuer.MsgIssueUserCredentialResponse")
}
...
var fileDescriptor_8167a165536ee83e = []byte{
	...
	,
}
...
func (c *msgClient) CreateIssuer(ctx context.Context, in *MsgCreateIssuer, opts ...grpc.CallOption) (*MsgCreateIssuerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/millicent.cash.issuer.Msg/CreateIssuer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BurnToken(ctx context.Context, in *MsgBurnToken, opts ...grpc.CallOption) (*MsgBurnTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/millicent.cash.issuer.Msg/BurnToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MintToken(ctx context.Context, in *MsgMintToken, opts ...grpc.CallOption) (*MsgMintTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/millicent.cash.issuer.Msg/MintToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) PauseToken(ctx context.Context, in *MsgPauseToken, opts ...grpc.CallOption) (*MsgPauseTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/millicent.cash.issuer.Msg/PauseToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) IssueUserCredential(ctx context.Context, in *MsgIssueUserCredential, opts ...grpc.CallOption) (*MsgIssueUserCredentialResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/millicent.cash.issuer.Msg/IssueUserCredential", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateIssuer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/millicent.cash.issuer.Msg/CreateIssuer",
	}
...
func _Msg_BurnToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/millicent.cash.issuer.Msg/BurnToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_MintToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/millicent.cash.issuer.Msg/MintToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_PauseToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/millicent.cash.issuer.Msg/PauseToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_IssueUserCredential_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/millicent.cash.issuer.Msg/IssueUserCredential",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "millicent.cash.issuer.Msg",
