...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/millicash/verifiablecredentials/verifiablecredentials
   */
  queryVerifiableCredentials = (
    ...
    this.request<VerifiablecredentialQueryVerifiableCredentialsResponse, RpcStatus>({
      path: `/millicash/verifiablecredentials/verifiablecredentials`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/millicash/verifiablecredentials/verifiablecredentials/{verifiable_credential_id}
   */
  queryVerifiableCredential = (verifiable_credential_id: string, params: RequestParams = {}) =>
    this.request<VerifiablecredentialQueryVerifiableCredentialResponse, RpcStatus>({
      path: `/millicash/verifiablecredentials/verifiablecredentials/${verifiable_credential_id}`,
      method: "GET",
      format: "json",
      ...params,
    });
